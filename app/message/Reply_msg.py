...
# 文字觸發 推播 Liff 嵌入式網頁   #未來展望：取得jquery +評論+liff.profile資訊+更多功能
    ...
    # 針對調酒風味re.match 文字訊息 作出reply
        ...
        Mellow_message = json.load(open("./cocktail_flavor/Mellow", 'r', encoding="utf-8"))
        ...
        Classic_message = json.load(open("./cocktail_flavor/Classic", 'r', encoding="utf-8"))
        ...
        Original_message = json.load(open("./cocktail_flavor/Original", 'r', encoding="utf-8"))
        ...
        herbal_message = json.load(open("./cocktail_flavor/herbal", 'r', encoding="utf-8"))
        ...
        Sweet_message = json.load(open("./cocktail_flavor/Sweet", 'r', encoding="utf-8"))
        ...
        Sour_message = json.load(open("./cocktail_flavor/Sour", 'r', encoding="utf-8"))
        ...
        Bittersweet_message = json.load(open("./cocktail_flavor/Bittersweet", 'r', encoding="utf-8"))
        ...
        light_message = json.load(open("./cocktail_flavor/light", 'r', encoding="utf-8"))
        ...
        Balanced_message = json.load(open("./cocktail_flavor/Balanced", 'r', encoding="utf-8"))
        ...
        Orange_message = json.load(open("./cocktail_flavor/Orange", 'r', encoding="utf-8"))
        ...
        Fruity_message = json.load(open("./cocktail_flavor/Fruity", 'r', encoding="utf-8"))
